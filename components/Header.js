          ...
          <div className="hidden md:flex-1 md:flex md:items-center md:justify-between">
            ...
            <div className="flex items-center md:ml-12">
              {/*{session ? (
                ...
                <Link href="/login">
                  <a className="ml-8 inline-flex items-center justify-center px-4 py-2 border-transparent rounded-md shadow-sm text-base font-medium text-gray hover:text-white border border-gray-600 hover:bg-gray-700">
                    Get Access
                  </a>
                </Link>
              )}*/}
